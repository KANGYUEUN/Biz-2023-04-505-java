package com.callor.classes.medels;
...
public class ScoreDto {
	...
	/*
	 * Java 의 모든 클래스는 기본적으로 toString method 를 포함한다.
	 * 하지만 기본 toString() 은 메모리 주소를 보여주는 코드가 포함 
	 * 
	 * Dto 클래스 에서는 변수의 값들을 문자열로 변환하여 리턴하는 메서드로 재정의 한다.
	 * 
	 * @Override : Annotation 키워드 
	 * 기존에 존재하는 method 를 다시 선언 하겠다는 지시어.
	 */
	@Override
