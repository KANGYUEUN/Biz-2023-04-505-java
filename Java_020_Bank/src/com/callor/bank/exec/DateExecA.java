...
public class DateExecA {
	 ...
	 * 자바에서는 1.8을 기준으로 날짜와 시간을 처리하는 방식 차이가 있다.
	 * 또한 프로그래밍 언어, 시스템, 국가, 소프트웨어 마다 처리하는 방식 차이가 있다.
	 * 
	 * 그래서 날짜와 관련된 이슈를 피해가기 위하여 여러 기법이 사용된다.
	 * 그중 많이 사용되는 방법중 하나가 ' 날짜 타입의 데이터를 문자열로 변환 ' 하여 사용 하는 것이다.
	 * 
	 */
	public static void main(String[] args) {
		...
		// Java 1.8 부터 사용하는 날짜 type 의 객체 3개다 동일하다.
